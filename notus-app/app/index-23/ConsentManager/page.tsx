...
const comparisonData: { category: string; rows: Row[] }[] = [
  {
    category: "Pricing",
    rows: [
      { feature: "Free plan", pc: "Yes — 3 domains, 5K pageviews", comp: "Yes — 3K views, 1 site" },
      { feature: "Cheapest paid plan", pc: "$9/mo (Starter)", comp: "$25/mo (Starter)" },
      { feature: "Mid-tier plan", pc: "$29/mo (Pro)", comp: "$64/mo (Essential, 3 sites)" },
      { feature: "Enterprise plan", pc: "$79/mo (unlimited)", comp: "$237/mo (20 sites)" },
      { feature: "Per-view overage", pc: "No overage charges", comp: "$0.02 – $0.12 per 1,000 views" },
    ],
  },
  {
    category: "Cookie Scanning",
    rows: [
      { feature: "Scan frequency (free)", pc: "2 scans/month", comp: "1 crawl/week" },
      { feature: "Scan frequency (paid)", pc: "Unlimited (Pro+)", comp: "3 – 50+ crawls/day" },
  ...
  },
  {
    ...
    rows: [
      { feature: "Banner customization", pc: "Advanced (all paid plans)", comp: "Premade (free) / Custom (paid)" },
      { feature: "A/B testing & optimization", pc: "Analytics dashboard", comp: "Essential+ plans" },
      { feature: "Remove branding / white label", pc: "Pro & Enterprise", comp: "Ultimate only (contact sales)" },
  ...
  },
  {
    ...
    rows: [
      { feature: "GDPR", pc: true, comp: true },
      { feature: "CCPA / CPRA", pc: true, comp: true },
      { feature: "Google Consent Mode v2", pc: true, comp: true },
      { feature: "IAB TCF + GPP", pc: "TCF 2.2", comp: "TCF + GPP (Essential+)" },
  ...
  },
  {
    ...
    rows: [
      { feature: "Privacy policy generator", pc: true, comp: "Starter+ plans" },
      { feature: "Whistleblowing & DSR tool", pc: "Not included", comp: "Essential+ plans" },
      { feature: "Legal Shield", pc: "Not included", comp: "Starter+ plans" },
    ],
  },
  {
    category: "Team & Support",
    rows: [
      { feature: "Multi-site dashboard", pc: true, comp: "Essential+ (3+ sites)" },
      { feature: "Team members", pc: "Up to unlimited", comp: "10+ user accounts (Professional)" },
      { feature: "White label", pc: "Enterprise", comp: "Ultimate only" },
      { feature: "Support (free)", pc: "Email", comp: "Tickets" },
      { feature: "Support (paid)", pc: "Priority (Pro+)", comp: "Ticket + Email + Phone" },
      { feature: "Personal account manager", pc: "Enterprise", comp: "Ultimate only" },
...
const advantages = [
  { icon: DollarSign, title: "Dramatically Lower Starting Price", desc: "PrivacyCrumb Starter is $9/mo. ConsentManager Starter is $25/mo — nearly 3x more expensive." },
  { icon: Globe, title: "No Overage Charges", desc: "Clear plan limits with no surprise bills. ConsentManager charges $0.02–$0.12 per 1,000 extra views." },
  { icon: Zap, title: "Simpler Pricing Tiers", desc: "4 clear plans vs ConsentManager's complex 5-tier structure with per-view overage pricing." },
  { icon: Shield, title: "Full API & Webhook Access", desc: "REST API and webhooks on paid plans. ConsentManager doesn't publicly document API access." },
];

const Cell = ({ value }: { value: string | true }) => {
  if (value === true) return <CheckCircle size={16} className="text-emerald-500 mx-auto" />;
  if (value === "Not specified" || value === "Not included") return <span className="text-red-400 text-xs">{value}</span>;
  return <span className="text-xs text-neutral-600 dark:text-neutral-400">{value}</span>;
};

export default function ConsentManagerComparePage() {
  return (
    <ThemeProvider>
      <Navbar />
      <main className="bg-white dark:bg-neutral-950 min-h-screen">
        <section className="text-center pt-24 pb-16 px-6 relative overflow-hidden grid-bg">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <FadeIn delay={0.1}><h1 className="text-[2.5rem] md:text-[3.25rem] font-semibold leading-[1.1] mb-5 tracking-tight text-neutral-900 dark:text-white">PrivacyCrumb vs <span className="bg-gradient-to-b from-[#F2A07A] to-coral bg-clip-text text-transparent">ConsentManager</span></h1></FadeIn>
            <FadeIn delay={0.2}><p className="text-neutral-500 dark:text-neutral-400 text-base max-w-lg mx-auto leading-relaxed">See how PrivacyCrumb compares to ConsentManager across pricing, scanning, compliance, and support.</p></FadeIn>
