      ...
      <main className="bg-white dark:bg-neutral-950 min-h-screen">
        ...
        <section className="py-12 bg-neutral-50/50 dark:bg-neutral-950 stripe-bg px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-0 border border-neutral-200/80 dark:border-neutral-800 rounded-3xl bg-white dark:bg-neutral-900">
              {plans.map((p, i) => (
                <FadeIn key={p.name} delay={i * 0.1} className="h-full">
                  <div className={`p-8 h-full relative flex flex-col ${i < 3 ? "border-r border-neutral-100 dark:border-neutral-800" : ""} ${p.featured ? "rounded-3xl z-10 bg-white dark:bg-neutral-900 shadow-[0_0_0_2px_rgb(23,23,23)] dark:shadow-[0_0_0_2px_white]" : ""}`}>
